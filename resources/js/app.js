    ...
    const _componentValidation = function() {
        ...
        const validator = $('.form-validate-jquery').validate({
            ...
            success: function(label, element) {
                ...
                element?.classList.remove('is-invalid')?.classList.add('is-valid');
        ...
        $('#reset').on('click', function() {
            // validator.resetForm();
            const textInputs = validator.errorContext.filter('input');

            // Log the text input elements to the console
